    ...
    <main className="min-h-screen bg-gray-50">
      <nav className="bg-white border-b border-gray-200 px-6 py-4 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <span className="text-gray-500 text-sm">Offres disponibles</span>
        </div>
        <div className="flex gap-3">
          <Link href="/candidat" className="text-sm text-gray-500 hover:text-gray-700">Mon espace</Link>
      ...
      <div className="max-w-3xl mx-auto p-8">
        <div className="mb-8">
          ...
          <p className="text-gray-500 mt-1">Postulez et passez un test de compétences pour vous démarquer</p>
        </div>
        ...
        {loading ? (
          ...
          <div className="text-center py-12 bg-white rounded-2xl border border-gray-200">
            <p className="text-gray-400 mb-2">Aucune offre disponible pour le moment</p>
            <p className="text-sm text-gray-300">Revenez bientôt !</p>
          </div>
        ) : (
                ...
                <div className="flex items-start justify-between gap-4">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      {offre.description && (
                        <p className="text-sm text-gray-500 mt-2 line-clamp-2">{offre.description}</p>
                      )}
                  ...
                  <Link href={`/offres/${offre.id}`}
                    className="bg-blue-600 text-white px-4 py-2 rounded-xl text-sm font-medium hover:bg-blue-700 transition flex-shrink-0">
                    Postuler
                  </Link>
                </div>
              </div>
